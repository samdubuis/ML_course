import datetime
print("Launched at time : ", datetime.datetime.now())
print("")
...
from surprise import SVD, SVDpp               # importer ici les algo qu'on testera
...
#######
algo=SVDpp(n_factors=20, n_epochs=100, lr_all=.001, reg_all=0.18014285714285713, verbose=True)
